...
const PlacesList = () => {
  ...
  const fetchPlaces = async () => {
    try {
      const response = await axios.get(`${VITE_REACT_APP_BACKEND_BASEURL_PLACE}/all`);
  ...
  const searchPlaces = async (query) => {
    ...
    try {
      const response = await axios.get(`${VITE_REACT_APP_BACKEND_BASEURL_PLACE}/search?query=${query}`);
  ...
  const handleMapNavigation = async (placeId) => {
    try {
      const response = await axios.get(`${VITE_REACT_APP_BACKEND_BASEURL_PLACE}/${placeId}/location`);
  ...
  const submitReview = async (placeId) => {
    ...
    try {
      await axios.post(`${VITE_REACT_APP_BACKEND_BASEURL_PLACE}/${placeId}/review`, {
        user: "Guest User",
